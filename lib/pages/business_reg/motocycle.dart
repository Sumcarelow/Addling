///Page to add motorcycle listing
...
class Motorcycle extends StatefulWidget {
  ...
  const Motorcycle({Key? key, required this.group, required this.bizID}) : super(key: key);
...
class _MotorcycleState extends State<Motorcycle> {
  ...
  ///Variables
  late String name, description, price, monthlyPrice, transmission = "Manual", addressPickUp, addressDropOff, extraPrice, pickUpCharge, dropOffCharge, deposit, productPic = logoURL, beds, sizes;
  ...
  Future getImage() async {
    var images = (
        await FilePicker.platform.pickFiles(
            allowMultiple: true,
            type: FileType.image,
            dialogTitle: "Please select motorcycle pictures."
        ))?.files;
  ...
  Future uploadProfilePicture(File image, String docID, String name) async {
    ...
    setState(() {
      isLoading = true;
      loadingScreenMsg = "Uploading motorcycle pictures...";
    });
        ...
        children: [
          Scaffold(
            appBar: AppBar(
              ...
              ///AppBar Title
              centerTitle: true,
              title: Text("Add Motorcycle Listing",
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        child: const Text("Add Motorcycle Listing"),
                      ),
                    )
