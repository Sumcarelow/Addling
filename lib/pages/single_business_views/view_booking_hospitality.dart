...
class ViewHospitality extends StatefulWidget {
  ...
  const ViewHospitality({Key? key, required this.listingID}) : super(key: key);
...
class _ViewHospitalityState extends State<ViewHospitality> {
  ...
  fetchData() async {
    ...
    await FirebaseFirestore.instance.collection('listings').where('id', isEqualTo: widget.listingID).get();
