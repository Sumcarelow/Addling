...
class ProductSelfLove extends StatefulWidget {
  final String listingID;
  final DocumentSnapshot listingDoc;
  const ProductSelfLove({Key? key, required this.listingID, required this.listingDoc}) : super(key: key);

  @override
  State<ProductSelfLove> createState() => _ProductSelfLoveState();
}

class _ProductSelfLoveState extends State<ProductSelfLove> {
  ///Variables
  late String bookingTime, bookingDate, yocoUrl;
  String id = '', moreInfo = '';
